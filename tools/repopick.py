...
if __name__ == '__main__':
    ...
    parser.add_argument('-g', '--gerrit', default='https://review.slimroms.org', help='Gerrit Instance to use. Form proto://[user@]host[:port]')
        ...
        if item['project'] in project_name_to_path:
            ...
            if project_path.startswith('hardware/qcom/'):
                ...
                if split_path[2] == 'audio' or split_path[2] == 'display' or split_path[2] == 'media':
                    ...
                    if len(split_branch) == 4 and split_branch[0] == 'slim' and split_branch[2] == 'caf':
